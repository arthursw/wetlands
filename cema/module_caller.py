...
parser = argparse.ArgumentParser('Cema module caller', 'Module caller is executed in a conda environment. It listens to a port and wait for execution orders. When told, it can import a module and execute one of its function.')
parser.add_argument('environment', help='The name of the execution environment.', required=True)
